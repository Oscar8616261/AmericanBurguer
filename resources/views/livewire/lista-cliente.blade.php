<div class="bg-[#e8e8eb] py-10">
  <div class="container mx-auto px-4">
      ...
      <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-3">
        <div class="w-full md:max-w-md">
          ...
          <div class="flex gap-2">
            <input wire:keydown.enter="clickBuscar()" type="search" wire:model="search" class="flex-1 px-4 py-2 border rounded-lg text-gray-900 bg-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500" placeholder="Nombre, CI">
    ...
    <h2 class="text-5xl font-bold text-center mb-4 text-blue-700">CLIENTES</h2>
          ...
          <tr class="hover:bg-gray-50">
            ...
            <td class="px-6 py-4">
              <div class="flex items-center gap-2">
                <button wire:click.prevent="editar({{ $item->id_cliente }})" class="bg-blue-600 hover:bg-blue-700 text-white font-semibold px-3 py-1.5 rounded">
                  <i class="fas fa-edit mr-1"></i> Editar
                </button>
                <button wire:click.prevent="delete({{ $item->id_cliente }})" class="bg-red-600 hover:bg-red-700 text-white font-semibold px-3 py-1.5 rounded">
    ...
    <div class="fixed inset-0 bg-black/50 flex items-center justify-center z-[9999]">
      <div class="bg-white rounded-xl shadow-xl w-full max-w-lg p-6">
        <div class="flex justify-between items-center mb-4">
          <h2 class="text-blue-700 font-bold text-lg">Datos del Cliente</h2>
        ...
        <form class="space-y-4">
          ...
          <div>
            ...
            <input wire:model="direccion" type="text" class="w-full px-3 py-2 border rounded text-gray-900 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500" required>
