<div>
    ...
    <div class="flex ...">
        <div class="flex-auto w-32 ...">
            <input  wire:keydown.enter="clickBuscar()" type="search" wire:model="search" class="w-full max-w-md px-4 py-2 text-sm text-[#000000] border border-[#37383a] rounded-lg bg-[#d1d4da] focus:ring-[#c70606] focus:border-[#c70606] " placeholder="Buscar Cliente" />
    ...
    <div class="bg-[#e8e8eb] py-10">
        <h2 class="text-6xl font-bold text-center mb-8">CLIENTES</h2>
        ...
        <div class="container mx-auto overflow-x-auto">
            <table class="min-w-full bg-white border border-gray-300 rounded-lg">
                ...
                <tbody>
                    @forelse ($clientes as $item)
                        <tr class="border-b hover:bg-gray-100">
                            ...
                            <td class="px-6 py-4 text-gray-700">
                                <!-- Botón Editar -->
                                <button wire:click.prevent="editar({{ $item->id_cliente }})" 
                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-3 rounded">
                                    Editar
                                </button>
                
                                <!-- Botón Borrar -->
                                <button wire:click.prevent="delete({{ $item->id_cliente }})" 
                    ...
                    @empty
                        <tr>
                            <td colspan="5" class="text-center px-6 py-4 text-gray-500">No hay clientes</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
    ...
    <div>
        ...
        <form class="max-w-md mx-auto">
            ...
            <!-- NIT -->
            <div class="relative z-0 w-full mb-5 group">
                <input wire:model="nit" type="text" name="floating_nit" id="floating_nit" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
