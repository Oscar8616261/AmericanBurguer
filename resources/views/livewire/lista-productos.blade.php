                ...
                <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                    ...
                    <div class="p-4">
                        <div class="flex justify-between items-center mb-2">
                            <h3 class="font-bold text-xl">{{$item->nombre}}</h3>
            ...
            <div class="bg-[#ffffff] p-6 rounded-lg w-96">
                ...
                <div class="mt-4">
                    <form class="max-w-md mx-auto">
                        ...
                        <!-- Foto -->
                        <div class="relative z-0 w-full mb-5 group">
                            <input wire:model="foto" type="file" name="repeat_foto" id="floating_repeat_foto" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-black dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " {{ $producto_id ? '' : 'required' }} />
                ...
                <div class="mt-4 flex justify-end space-between gap-2">
                    <button wire:click="enviarClick()" type="submit" class="flex-1 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Enviar</button>
                    <button wire:click="closeModal" class="flex-1 bg-gray-500 text-white py-2 px-4 rounded-md hover:bg-gray-600">Cerrar</button>
                </div>
            </div>
        </div>
        @endif
